...
<head>
    ...
    <link rel="shortcut icon" href="img/banklogofinal.jfif">
...
?>
        ...
        <h2 class="text-center pt-4" style="color: BLUE;">CREATE USER</h2>
        <br>

  <div class="background">
  <div class="container">
    <div class="screen">
      <div class="screen-header" style="background: BLUE;">
